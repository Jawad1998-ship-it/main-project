...
namespace Donation_Website.Pages
{
    public class ResetPasswordModel : PageModel
    {
        ...
        private void UpdatePasswordInDatabase(string email, string newPassword)
        {
            ...
            using (var connection = new SqlConnection("Data Source=TOKEY-ZAWAD\\SQLEXPRESS;Initial Catalog=DonationManagementDB;Integrated Security=True;Encrypt=False;Trust Server Certificate=True"))
            {
                connection.Open();
